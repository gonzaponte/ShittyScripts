...
F = TFile( "/Users/Gonzalo/github/elparametrization/PyScripts/ParamBuilder/NEW_S2PMTparametrization_plots.root")
...
M.Draw('ap')
C.Modified()
C.SaveAs("pmt_sampling_error_{0}.png".format(pitch))